...
#include <Awl/boost/function_types/is_function_pointer.hpp>
#include <Awl/boost/function_types/is_function_reference.hpp>
#include <Awl/boost/function_types/result_type.hpp>
