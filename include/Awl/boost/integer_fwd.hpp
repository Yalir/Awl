...
#include <Awl/boost/config.hpp>  // for BOOST_NO_INTRINSIC_WCHAR_T
#include <Awl/boost/limits.hpp>  // for std::numeric_limits
#include <Awl/boost/cstdint.hpp>  // For intmax_t
...
//  From <Awl/boost/cstdint.hpp>  ------------------------------------------------//

// Only has typedefs or using statements, with #conditionals


//  From <Awl/boost/integer_traits.hpp>  -----------------------------------------//
...
//  From <Awl/boost/integer/integer_mask.hpp>  -----------------------------------//
...
//  From <Awl/boost/integer/static_log2.hpp>  ------------------------------------//
...
//  From <Awl/boost/integer/static_min_max.hpp>  ---------------------------------//
