...
#   include <Awl/boost/mpl/aux_/config/lambda.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <Awl/boost/mpl/apply.hpp>))
