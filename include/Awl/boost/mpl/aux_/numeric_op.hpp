...
#   include <Awl/boost/mpl/aux_/preprocessor/sub.hpp>
#   include <Awl/boost/mpl/aux_/config/ctps.hpp>
#   include <Awl/boost/mpl/aux_/config/eti.hpp>
#   include <Awl/boost/mpl/aux_/config/msvc.hpp>
#   include <Awl/boost/mpl/aux_/config/workaround.hpp>

#   include <Awl/boost/preprocessor/dec.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,( BOOST_PP_DEC(AUX778076_OP_ARITY), 2, <Awl/boost/mpl/aux_/numeric_op.hpp> ))
