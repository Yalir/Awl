...
#include <Awl/boost/mpl/aux_/preprocessor/is_seq.hpp>

#include <Awl/boost/preprocessor/if.hpp>
#include <Awl/boost/preprocessor/logical/bitand.hpp>
#include <Awl/boost/preprocessor/logical/compl.hpp>
