...
#   include <Awl/boost/mpl/aux_/lambda_spec.hpp>
#endif
...
#   include <Awl/boost/mpl/aux_/config/forwarding.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <Awl/boost/mpl/unpack_args.hpp>))
