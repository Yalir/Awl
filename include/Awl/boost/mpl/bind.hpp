...
#   include <Awl/boost/mpl/bind_fwd.hpp>
#   include <Awl/boost/mpl/placeholders.hpp>
#   include <Awl/boost/mpl/next.hpp>
#   include <Awl/boost/mpl/protect.hpp>
#   include <Awl/boost/mpl/apply_wrap.hpp>
#   include <Awl/boost/mpl/limits/arity.hpp>
#   include <Awl/boost/mpl/aux_/na.hpp>
#   include <Awl/boost/mpl/aux_/arity_spec.hpp>
#   include <Awl/boost/mpl/aux_/type_wrapper.hpp>
#   include <Awl/boost/mpl/aux_/yes_no.hpp>
#   if defined(BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION)
#       include <Awl/boost/type_traits/is_reference.hpp>
#   endif 
#endif

#include <Awl/boost/mpl/aux_/config/bind.hpp>
#include <Awl/boost/mpl/aux_/config/static_constant.hpp>
#include <Awl/boost/mpl/aux_/config/use_preprocessed.hpp>
...
#   endif
#   include <Awl/boost/mpl/aux_/include_preprocessed.hpp>

#else

#   include <Awl/boost/mpl/aux_/preprocessor/params.hpp>
#   include <Awl/boost/mpl/aux_/preprocessor/default_params.hpp>
#   include <Awl/boost/mpl/aux_/preprocessor/def_params_tail.hpp>
#   include <Awl/boost/mpl/aux_/preprocessor/partial_spec_params.hpp>
#   include <Awl/boost/mpl/aux_/preprocessor/ext_params.hpp>
#   include <Awl/boost/mpl/aux_/preprocessor/repeat.hpp>
#   include <Awl/boost/mpl/aux_/preprocessor/enum.hpp>
#   include <Awl/boost/mpl/aux_/preprocessor/add.hpp>
#   include <Awl/boost/mpl/aux_/config/dmc_ambiguous_ctps.hpp>
#   include <Awl/boost/mpl/aux_/config/ctps.hpp>
#   include <Awl/boost/mpl/aux_/config/ttp.hpp>
#   include <Awl/boost/mpl/aux_/config/dtp.hpp>
#   include <Awl/boost/mpl/aux_/nttp_decl.hpp>

#   include <Awl/boost/preprocessor/iterate.hpp>
#   include <Awl/boost/preprocessor/comma_if.hpp>
#   include <Awl/boost/preprocessor/cat.hpp>
#   include <Awl/boost/preprocessor/inc.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <Awl/boost/mpl/bind.hpp>))
...
#   define BOOST_PP_ITERATION_PARAMS_1 (3,(3, 3, <Awl/boost/mpl/bind.hpp>))
#   include BOOST_PP_ITERATE()
...
#include <Awl/boost/mpl/aux_/count_args.hpp>
}
...
#       define BOOST_PP_ITERATION_PARAMS_2 (3,(1, i_, <Awl/boost/mpl/bind.hpp>))
#       include BOOST_PP_ITERATE()
