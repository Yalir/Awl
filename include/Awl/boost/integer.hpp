...
//   01 Apr 01  Modified to use new <Awl/boost/limits.hpp> header. (John Maddock)
...
#include <Awl/boost/integer_fwd.hpp>  // self include

#include <Awl/boost/integer_traits.hpp>  // for boost::::boost::integer_traits
#include <Awl/boost/limits.hpp>          // for ::std::numeric_limits
#include <Awl/boost/cstdint.hpp>         // for boost::int64_t and BOOST_NO_INTEGRAL_INT64_T
